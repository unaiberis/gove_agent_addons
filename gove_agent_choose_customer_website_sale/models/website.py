...
class Website(models.Model):
    ...
    def sale_get_order_without_updating_pricelist(
        self,
        force_create=False,
        code=None,
        ...
        if sale_order and sale_order.get_portal_last_transaction().state in (
            "pending",
            "authorized",
            "done",
        ):
        ...
        if (
            ...
            and sale_order.partner_id not in partner.agent_customers
        ):
