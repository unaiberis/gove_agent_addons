...
class Website(models.Model):
    ...
    def sale_get_order_without_updating_pricelist(self, force_create=False, code=None, update_pricelist=False, force_pricelist=False):
    ...
    def sale_get_order(self, force_create=False, code=None, update_pricelist=False, force_pricelist=False):
        ...
        # update the pricelist
        if update_pricelist and any(line.exists() and line.pricelist_id.id != pricelist_id for line in sale_order.order_line):
            request.session['website_sale_current_pl'] = pricelist_id
            values = {'pricelist_id': pricelist_id}
            sale_order.write(values)
            for line in sale_order.order_line:
